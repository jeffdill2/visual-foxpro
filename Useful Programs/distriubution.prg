...
ELSE
	...
	**************************************************************************************************************
	IF PARAMETERS() > 1 THEN
		cSelectStatement = 'select ' + cInputText + ', count(*) as quantity from "' + cInputTable + '" order by ' + cInputText + ' group by ' + cInputText + ' where ' + cWhere
	ELSE
		cSelectStatement = 'select ' + cInputText + ', count(*) as quantity from "' + cInputTable + '" order by ' + cInputText + ' group by ' + cInputText
	ENDIF
	&cSelectStatement 
	**************************************************************************************************************
	**************************************************************************************************************
